...
def data_ida_menor_data_hoje(data_ida, data_pesquisa, lista_de_erros):
    '''
    Verifica se data de ida é menor que a data de pesquisa/hoje.
    :param data_ida: date.
    :param data_pesquisa: date.
    :param lista_de_erros: []
    :return:
    '''

    if data_ida < data_pesquisa:
        lista_de_erros['data_ida'] = 'Data de ida não pode ser menor que a data de pesquisa/hoje.'